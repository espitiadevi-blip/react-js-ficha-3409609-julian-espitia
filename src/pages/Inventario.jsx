...
function Inventario() {
  ...
  const vaciarInventario = () => {
    if (productos.length === 0) {
      mostrarMensaje("El inventario ya está vacío.");
      return;
    }
    ...
    <div className="inventario-page">
      ...
      <section className="toolbar">
        ...
        <select
          className="select-input"
          value={estadoStock}
          onChange={(evento) => setEstadoStock(evento.target.value)}
        >
      ...
      <section className="catalog-section">
        <div className="catalog-heading">
          <h2>Productos</h2>
          <span>{productosOrdenados.length} producto(s)</span>
        </div>
